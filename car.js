class Car {
    constructor(x, y, width, height, keysEnabled = false, maxSpeed = 3) {
        this.x = x;
        this.y = y;
        this.width = width;
        this.height = height;
        ...
        this.friction = 0.05;
        this.angle = 0;
        this.isUserMovable = keysEnabled;
        if (keysEnabled) {
            this.sensor = new Sensor(this);
            this.brain = new NeuralNetwork([this.sensor.rayCount, 6, 4]);
        }
        this.controls = new Controls(keysEnabled);
    }

    /**
     * Updates the state of the car
     * @param {*} roadBorders - road value, which allows boundary checking
     * @param {*} trafficlayout - contains all the traffic
     */
